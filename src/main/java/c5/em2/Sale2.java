...
@Getter
public class Sale2 extends Employer2 implements YearScore, Over4Season {
  ...
  public Sale2(String name, Integer season1Score, Integer season2Score,
  ...
  public Sale2(String name, BigInteger season1Score, BigInteger season2Score,
